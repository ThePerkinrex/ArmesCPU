...
// pub fn error_as_report(r: nom::Err<Error<Span>>) -> Report {
//     let r = match r {
...
//         }
//         Error::Alt(a) => a.into_iter().flat_map(error_tree_as_report).collect(),
//     }
// }
